        ...
        className={cn(
          "flex h-full items-center whitespace-nowrap text-blue-700 dark:text-blue-200",
          {
            "border-b-2 border-blue-600 dark:border-blue-500":
              selected && typeof link.label !== "function" && !useDropdownMenu,
    ...
    >
      ...
      >
        <div className="relative flex items-center space-x-3 overflow-auto">
          <Link
            href="/"
            className="flex h-8 w-8 shrink-0 origin-bottom items-center justify-center rounded-full bg-blue-700 p-1 dark:bg-blue-200"
          >
            {useLightLogo ? (
              <ReactSVG
