...
// The family's saved minutes drawn as a clock face that fills up a quarter at
// a time — it grows and stays put, never counts down. Full hours drop out of
// the face and are counted as dots underneath, so a kid can add them up by
// pointing.
export function TimeClock({ minutes, size = 132 }: TimeClockProperties) {
  ...
  return (
    <View className="items-center gap-2">
      <Svg width={size} height={size} accessibilityLabel={`${minutes} minutes saved`}>
        ...
        <Circle cx={center} cy={center} r={4} fill={border} />
      </Svg>
