    ...
    <>
      ...
      >
        <View className="items-center gap-3 pt-2">
          <View className="size-44 items-center justify-start overflow-hidden rounded-full bg-surface">
            <PersonAvatar person={person.key} mood={record?.mood} width={176} height={232} />
          </View>
